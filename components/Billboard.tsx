...
const Billboard: React.FC = () => {
  ...
  const handleOpenModal = useCallback(() => openModal(movie?.id || ""), [openModal, movie]);
  ...
  return (
    <div className="relative w-full h-[50vw]">
      ...
      <div className="absolute top-[30%] md:top-[50%] ml-4 md:ml-8">
        ...
        <p className="text-white text-xs  capitalize md:text-lg h-full mt-2 md:mt-4 w-1/2 md:w-4/5 lg:w-1/2  lg:text-xl  drop-shadow-xl">{movie?.description}</p>
        {!isLoading && (
